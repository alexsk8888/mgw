...
Container::make("post_meta", "Первичная уборка")
    ...
    ->add_fields( array(
        ...
        Field::make( 'complex', 'views', 'кнопка  максимум 10шт' )->set_layout( 'tabbed-horizontal' )->set_max( 10 )
            ->add_fields( array(
                Field::make( 'textarea', 'view_title', __( ' Заголовок кнопки' ))->set_width( 15 ),
                Field::make( 'image', 'view_icon', __( ' Изображение' ) )->set_width( 10 ),
                Field::make( 'textarea', 'view_alt', __( ' "Alt" Фонового изображения' ))->set_width( 15 ),
                Field::make( 'rich_text', 'view_description', __( ' Описание' ))->set_width( 60 ),
            ) ),
