let multiItemSlider = (function () {
    ...
    return function (selector, config) {
        ...
        let _refresh = function () {
            ...
            _sliderWrapper = _mainElement.querySelector('.slider_wrapper');
            _sliderItems = _mainElement.querySelectorAll('.slider_item');
            _sliderControls = _mainElement.querySelectorAll('.slider_control');
            _sliderControlLeft = _mainElement.querySelector('.slider_control_left');
            _sliderControlRight = _mainElement.querySelector('.slider_control_right');
